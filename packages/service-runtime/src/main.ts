...
console.log(JSON.stringify({ event: "originos.service.started", baseUrl: service.baseUrl, dataDirectory: config.dataDirectory, storage: config.databaseUrl ? "postgresql" : "json", version: "0.14.0-alpha.1", apiVersion: "2.0.0" }));
