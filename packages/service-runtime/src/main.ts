...
console.log(JSON.stringify({ event: "originos.service.started", baseUrl: service.baseUrl, dataDirectory: config.dataDirectory, storage: config.databaseUrl ? "postgresql" : "json", version: "0.17.0-rc.5", apiVersion: "2.0.0" }));
